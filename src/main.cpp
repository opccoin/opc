...
// Copyright (c) 2017 The OPCCoin Developers
...
uint256 hashGenesisBlock("00000cd8e937c647c99a0b6f53dd4fc0710f2cab5d769088fc2119bcbdacffea");//，替换2.0
static const unsigned int timeGenesisBlock = 1521104672;//1456048686;//替换1.0
...
const string strMessageMagic = "OPCCoin Signed Message:\n";
...
bool InitBlockIndex() {
    ...
    if (!fReindex) {
        ...
        // Genesis block
       const char* pszTimestamp = "already in already databases we OPCCoin from USA with Transactions.";
        CTransaction txNew;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        ...
        block.nNonce   = 865003;//替换1.2，替换2.2
        ...
        block.print();
        assert(block.hashMerkleRoot == uint256("7b83cc9f0945dd65acc7b1f7bda44537ef26763635bcd02f0a7135da8cff4ddb"));//替换2.1
...
bool CheckWork(CBlock* pblock, CWallet& wallet, CReserveKey& reservekey)
{
    ...
    // Found a solution
    {
        ...
        if (pblock->hashPrevBlock != hashBestChain)
            return error("OPCCoinMiner : generated block is stale");
        ...
        if (!ProcessBlock(state, NULL, pblock))
            return error("OPCCoinMiner : ProcessBlock, block not accepted");
    }
...
{
    printf("OPCCoinMiner started\n");
    SetThreadPriority(THREAD_PRIORITY_LOWEST);
    RenameThread("OPCCoin-miner");
    ...
    try { loop {
        ...
        printf("Running OPCCoinMiner with %"PRIszu" transactions in block (%u bytes)\n", pblock->vtx.size(),
...
//            unsigned int nNonceFound;
    ...
    {
        printf("OPCCoinMiner terminated\n");
        throw;
    }
}
