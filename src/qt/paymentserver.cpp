...
const QString BITCOIN_IPC_PREFIX("OPCCoin:");
...
{
    // Install global event filter to catch QFileOpenEvents on the mac (sent when you click OPCCoin: links)
    ...
    if (!uriServer->listen(name))
        qDebug() << tr("Cannot start OPCCoin: click-to-pay handler");
    else
...
{
    // clicking on OPCCoin: URLs creates FileOpen events on the Mac:
